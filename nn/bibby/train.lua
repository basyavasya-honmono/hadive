...
local args = lapp [[
    ...
    --train_images       (default 'data/20160626_tensors/X_dev.npy') training images
    --train_labels       (default 'data/20160626_tensors/y_dev.npy') training labels
    --test_images        (default 'data/20160626_tensors/X_val.npy') test images
    --test_labels        (default 'data/20160626_tensors/y_val.npy') test labels
    ]]
