...
\subsection*{Faster RCNN training}
 - Tools utilized (small-corgi, Tensorflow)
 - Model structure. VGG
 - How many iterations. 90,000
 - Learning rate. 0.005
 - RPN positive overlap of 0.7, minimu size of 2.
 - Proposal method gt.
